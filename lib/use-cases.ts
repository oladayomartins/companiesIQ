...
export const USE_CASES: UseCase[] = [
  // ---------------------------------------------------------- Accountants
  {
    ...
    faqs: [
      ...
      ["Can I export the list to contact them?", "Yes. Any filtered list exports to CSV, and Pro plans add API access so the companies drop straight into your CRM or practice tool. Companies House data is public record under the Open Government Licence — but your outreach still has to follow UK marketing rules (PECR/GDPR), especially for email."],
  ...
  // ---------------------------------------------------------- Recruiters
  {
    ...
    faqs: [
      ...
      ["Can I export the leads into my CRM?", "Yes. Any list exports to CSV, and Pro plans include API access to push employers straight into your recruitment CRM. Data is public record under the Open Government Licence; your outreach still has to follow UK marketing rules."],
  ...
  // ---------------------------------------------------------- Marketing agencies
  {
    ...
    faqs: [
      ...
      ["Can I export the prospects?", "Yes. Any list exports to CSV, and Pro plans add API access to push prospects into your outbound tool. The data is public record under the Open Government Licence; your outreach still needs to follow UK marketing rules (PECR/GDPR)."],
  ...
  // ---------------------------------------------------------- Sales teams
  {
    ...
    faqs: [
      ...
      ["Can I push accounts into my CRM?", "Yes. Any list exports to CSV, and Pro plans include API access to sync companies directly into your CRM or sales-engagement tool. Every field is sourced from the public register and dated."],
  ...
  // ---------------------------------------------------------- Insurance / finance brokers
  {
    ...
    faqs: [
      ...
      ["Can I export the leads?", "Yes. Lists export to CSV, and Pro plans include API access to push prospects into your CRM. Companies House data is public record under the Open Government Licence; your outreach must still follow UK marketing rules (PECR/GDPR)."],
